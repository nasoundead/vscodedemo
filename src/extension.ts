...
export function activate(context: vscode.ExtensionContext) {
	...
	console.log('Congratulations, your extension "vscodedemo" is now active!');
	...
	let disposable = vscode.commands.registerCommand('vscodedemo.helloWorld', () => {
		...
		vscode.window.showInformationMessage('Hello World from VsCodeDemo!');
	});
	...
	outputPanel.append("hello world");
